...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
        title: 'Mealify',
        home: const MyHomePage(title: 'Mealify'),
        ...
        child: Column(
          ...
          children: <Widget>[
              ...
              children: [
                ...
                Expanded(
                  child: DropdownButtonFormField(
                    key: _key,
                    isExpanded: true,
                    items: units.map((String category) {
                                ...
                                RoundedRectangleBorder(
                                    ...
                                    side: BorderSide(
                                        color:
                                            Color.fromARGB(255, 28, 1, 104))))),
                    onPressed: () => setState(() {
                          ingredientsPageList.add(
                              IngredientTile(_ingredient, _quantity, _unit));
            ...
            Expanded(
                child: SizedBox(
              height: 200,
              child: IngredientsPageListViewBuilder(ingredientsPageList),
            ))
          ],
        ),
...
class _IngredientsPageListViewBuilderState
    extends State<IngredientsPageListViewBuilder> {
  @override
  Widget build(BuildContext context) {
        ...
        itemBuilder: (BuildContext ctxt, int index) {
          return Dismissible(
            ...
            onDismissed: (direction) {
              ...
              setState(() {
                widget._ingredientsPageList.removeAt(index);
              });
            },
            background: Container(color: Color.fromARGB(255, 110, 3, 137)),
            child: Container(
                padding: EdgeInsets.fromLTRB(16, 4, 16, 4),
                child: widget._ingredientsPageList[index]),
          );
        });
  }
}
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Card(
            child: ListTile(
          title: Text(
              widget.ingredient + " — " + widget.quantity + " " + widget.unit),
        )));
  }
}
